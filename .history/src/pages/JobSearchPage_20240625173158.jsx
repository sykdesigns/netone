    ...
    <div className="flex h-full w-full">
      ...
      <div className="flex flex-col flex-grow">
        ...
        <main className="p-2 flex-grow bg-n1-white">
          ...
          <div className="flex flex-wrap gap-6 lg:ml-12 max-w-full">
          ...
          {itemsToShow < filteredJobs.length && (
            <div className="flex justify-center mt-4">
              <button 
                className="text-n1-orange text-xs px-4 py-2 font-demiBold hover:text-n1-blue" 
      ...
      {selectedJob && (
        <JobDetailsModal
          ...
          onApplyNow={() => handleOpenJobApp(selectedJob)}
        />
      )}
      {applyingJob && (
        <JobAppModal
