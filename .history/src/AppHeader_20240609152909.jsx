    ...
    return (
        ...
        <div className='max-w-screen-2xl h-24 bg-n1-blue-light flex items-center font-custom'>
            ...
            <form class="ml-12 relative">   
                ...
                <div className='absolute inset-y-3 inset-x-1 text-n1-gray-light'> <FaMagnifyingGlass /> </div>
                <input type='text' placeholder='Search for a job' className='mr-12 max-w-lg h-10 p-4 text-xxs text-gray-100'></input>
