        ...
        <div className="flex flex-col w-full m-8">
          ...
          <form>
            ...
            <div class="flex w-full justify-center ">
                <label for="dropzone-file" class="w-9/12 items-center h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
