...
const AppHeader = () => {
    ...
    return (
        ...
        <form className='ml-auto flex items-center w-full max-w-lg'>
            <div className='relative flex-grow'>
            <div className='absolute inset-y-0 left-0 flex items-center pl-3 text-n1-gray-mid'>
                <FaMagnifyingGlass />
            </div>
            <input type='text' placeholder='Search for a job' className='w-full h-10 p-4 pl-10 text-xs' />
            </div>
        </form>
        </div>
