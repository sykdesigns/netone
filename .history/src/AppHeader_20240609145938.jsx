...
const AppHeader = () => {
    ...
    return (
        ...
        <div className='max-w-screen-2xl h-24 bg-n1-blue-light flex items-center font-custom bg-n1-blue'>
            ...
            <form class="ml-auto mr-12">   
                
               <div className=''>
                <input type='text' placeholder='Search for a job' className='w-96 h-10 p-4 text-xxs text-gray-100'></input>
               </div>
            </form>
