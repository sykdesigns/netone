...
const Sidebar = () => {
  ...
  return (
    ...
    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" onClick={handleToggle}>
      {collapsed ? <GoSidebarExpand size={20} /> : <GoSidebarCollapse size={20} />}
        ...
        <div className={`${collapsed ? 'hidden' : 'block'} mt-4 text-center`}></div>
            ...
            <div className='w-1/2 flex flex-col justify-center'>
              ...
              <button className="bg-orange-500 text-xs">Logout</button>
            </div>
