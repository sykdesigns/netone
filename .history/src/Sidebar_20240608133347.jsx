...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-n1-blue text-white ${collapsed ? 'w-20' : 'w-64'} transition-all duration-300 h-full flex flex-col`}>

        <button className="bg-n1-blue text-white w-full py-2" onClick={handleToggle}>
          {collapsed ? 'Expand' : 'Collapse'}
        </button>

      <div className="flex p-4 bg-n1-blue">
