...
const AppHeader = () => {
    ...
    return (
        ...
        <div className='max-w-screen-2xl h-24 bg-n1-blue-light flex items-center font-custom p-12'>
            
            <div className='text-2xl text-n1-blue'>
                <h1>Open Jobs</h1>
            </div>
  
            <div className='ml-3 bg-n1-orange text-n1-white py-1 px-3 rounded-full w-8 h-8 text-nd flex items-center justify-center'>
            {jobData.length}
            </div>
