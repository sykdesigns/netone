  ...
  return (
    <div className="fixed inset-0 flex justify-center z-50">
      <div className="bg-white w-screen h-screen overflow-auto font-custom text-n1-blue">
        ...
        <div className='flex flex-col gap-4 pl-8 pt-4 pb-4 bg-n1-blue-light'>
        ...
        <div className='flex flex-col gap-4 pl-8 pt-4 pb-4'>
        ...
        <div className='flex flex-col gap-4 pl-8 pt-4 pb-4 pr-2'>
