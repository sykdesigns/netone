    ...
    <div className="fixed inset-0 flex justify-center z-50">
      <div className="bg-white w-screen h-screen overflow-auto text-n1-blue">
        ...
        <div className='flex bg-n1-blue-light'>
            ...
            <button onClick={onClose} className="bg-n1-orange rounded-full w-6 h-6 flex items-center justify-center text-sm text-n1-white font-demiBold flex ml-auto">X</button>
            </div>
        </div>

        <div className='flex'>
            <div className="w-full text-lg p-4">
            <h2 className='font-demiBold font-custom'>Job Details:</h2>
            </div>
        </div>
