        ...
        <main className="p-4 flex-grow bg-n1-white">
          ...
          <div className="flex justify-between items-center m-20">
            <div className="text-n1-blue text-sm">
              Showing <span className='text-n1-orange'>{Math.min(resultsSoFar, jobData.length)}</span>  Results of <span className='text-n1-orange'> {jobData.length}</span>
            </div>
            <div className="flex items-center text-xs">
              <button
                className="bg-n1-orange text-n1-white px-2 py-1 rounded-full m-1"
              ...
              {[...Array(totalPages).keys()].map((page) => (
                <button
                  key={page + 1}
                  className={`px-2 py-1 m-1 rounded-full text-sm ${currentPage === page + 1 ? 'bg-n1-orange text-n1-white' : 'bg-n1-white text-n1-blue'}`}
              ...
              <button
                className="bg-n1-orange text-n1-white px-2 py-1 rounded-full m-1 text-sm"
