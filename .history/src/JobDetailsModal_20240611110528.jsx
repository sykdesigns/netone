    ...
    <div className="fixed inset-0 flex justify-center z-50">
      <div className="bg-white w-screen h-screen overflow-auto font-custom text-n1-blue">
        ...
        <div className='flex bg-n1-blue-light'>
            ...
            <button onClick={onClose} className="text-n1-orange text-xl font-demiBold flex ml-auto">X</button>
            </div>
        </div>
        ...
        <div className='flex flex-col gap-4 pl-7 pt-4 pb-4 pr-3'>
                ...
                <div className='w-full leading-relaxed text-sm'><span className='font-demiBold'>Project Summary:</span> {job["Project Summary"]}</div>
        ...
        <div className='flex p-4 items-center justify-center mt-4'>
            ...
            <button className='ml-2 bg-n1-orange text-base px-7 py-2 rounded-full text-n1-white'>Apply Now</button>
        </div>
      </div>
    </div>
  );
