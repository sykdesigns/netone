    ...
    <div className="fixed inset-0 flex justify-center z-50">
      <div className="bg-white w-screen h-screen overflow-auto font-custom text-n1-blue">
        ...
        <div className='flex flex-col gap-4 p-5 bg-n1-blue-light'>
                ...
                <div className='w-full ml-4'><span className='font-demiBold'>Start Date:</span> {job["Start Date"]}</div>
                <div className='w-full ml-4'><span className='font-demiBold'>Duration:</span> {job.Duration}</div>
                <div className='w-full ml-4'><span className='font-demiBold'>Billing Rate W2:</span> {job["Billing Rate W2"]}</div>
