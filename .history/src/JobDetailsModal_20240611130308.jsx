    ...
    <div className="fixed inset-0 flex justify-center z-50">
      <div className="bg-white w-screen h-screen overflow-auto text-n1-blue">
        ...
        <div className='flex bg-n1-blue-light'>
            ...
            <button onClick={onClose} className="bg-n1-orange rounded-full w-8 h-8 flex items-center justify-center text-n1-white text-xl font-demiBold flex ml-auto">X</button>
            </div>
        </div>
