    ...
    <div className="fixed inset-0 flex justify-center z-50">
      <div className="bg-white w-screen h-screen overflow-auto text-n1-blue">
        ...
        <div className='flex bg-n1-blue-light'>
            <div className='w-3/4 p-6 font-custom'>
        ...
        <div className='flex'>
            ...
            <h2 className='font-custom font-demiBold font-custom font-custom'>Job Details:</h2>
            </div>
        </div>
        ...
        <div className='flex p-4 items-center justify-center mt-4 font-custom'>
