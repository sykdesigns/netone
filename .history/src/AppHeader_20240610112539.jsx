...
const AppHeader = () => {
    ...
    return (
        ...
        <div className='w-full h-24 bg-n1-blue-light flex items-center font-custom p-7'>
            
            <div className='md:text-2xl text-n1-blue'>
                <h1>Open Jobs</h1>
            </div>
  
            <div className='ml-3 bg-n1-orange text-n1-white py-1 px-3 rounded-full w-6 h-6 md:w-8 md:h-8 text-xs md:text-sm flex items-center justify-center'>
            {jobData.length}
            </div>
