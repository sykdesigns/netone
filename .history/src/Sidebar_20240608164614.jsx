...
<div className="bg-gray-500 text-white w-64 h-screen flex flex-col">
      ...
      <nav className="mt-4 flex-grow ml-4 mr-4 font-custom-300 tracking-wide text-base">

              <div className='flex items-center pl-4 pb-4 border-b mb-4'>
              <FaMagnifyingGlass /> 
