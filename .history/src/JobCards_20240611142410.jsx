...
const JobCards = ({ postDate, position, industry, projectSummary, billingRateW2, billingRateIC, location, onViewDetails }) => {
  ...
  return (
    <div className='relative flex flex-col lg:w-80 lg:h-70 bg-n1-blue-light p-4 rounded-lg shadow-md'>
      <div className='flex mb-2 text-2xl items-start'>
        <div className='bg-n1-white w-12 h-12 rounded-full flex items-center justify-center md:justify-start text-n1-blue'>    
          <SiChianetwork />
        </div>
