...
<div className="bg-n1-blue text-n1-white w-64 h-screen flex flex-col font-custom font-medium">
        ...
        <div className="flex p-4 w-64">
            ...
            <div className='w-1/2 flex flex-col justify-center'>
              ...
              <p className='text-xs text-center font-thin'>AVAILABILITY STATUS</p>
              <button className="bg-orange-500 uppercase hover:bg-blue-700 text-white py-2 text-xs mt-2 rounded-full">Logout</button>
            </div>
        </div>

      <nav className="mt-4 flex-grow ml-4 mr-4 tracking-wide text-base">

              <div className='flex items-center pl-4 pb-4 pt-2 border-b mb-4'>
              <FaMagnifyingGlass /> 
              <a href="#" className='ml-4 font-medium'>Search Jobs</a>
              </div>
