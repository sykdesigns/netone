  ...
  return (
    <div className="fixed inset-0 flex justify-center z-50">
      <div className="bg-white w-screen h-screen overflow-auto font-custom text-n1-blue">
        ...
        <div className='flex flex-col p-4 bg-n1-blue-light h-48 items-center'>
            ...
            <div className='w-full'>
                <p className='font-demiBold mb-8'>Onsite / Remote:</p>
            </div>

            <div className='w-full'>
                <p className='font-demiBold mb-8'>Hours Per Week:</p>
            </div>
