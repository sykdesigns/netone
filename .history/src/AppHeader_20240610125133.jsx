...
const AppHeader = () => {
    ...
    return (
        ...
        <div className='w-full h-16 bg-n1-blue-light flex items-center justify-center font-custom gap-4 p-3'>
            ...
            <form className='flex-grow flex items-center relative'>   
                ...
                className='w-11/12 h-10 pl-10 text-xs border border-gray-300 rounded-lg'
                />
            </form>
