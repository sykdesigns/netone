  ...
  return (
    <div className='flex flex-col w-80 h-72 bg-n1-white p-4 rounded-lg shadow-lg'>
      ...
      <div className='flex justify-center'>
        <button className='bg-n1-white border-2 border-n1-blue-mid text-n1-blue text-xs px-4 py-2 rounded-full mr-4'>View Details</button>
        <button className='bg-n1-blue text-n1-white text-xs rounded-full px-4 py-2 rounded-lg'>Apply Now</button>
      </div>
