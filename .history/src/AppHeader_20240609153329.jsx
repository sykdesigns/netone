...
const AppHeader = () => {
    ...
    return (
        ...
        <div className='max-w-screen-2xl h-24 bg-n1-blue-light flex items-center font-custom'>
            ...
            <form class="ml-6 relative text-n1-gray-mid">   
                
                <div className='absolute inset-y-3 inset-x-2 text-n1-gray-mid'> <FaMagnifyingGlass /> </div>
                <input type='text' placeholder='Search for a job' className='mr-12 max-w-lg h-10 p-4 pl-8 text-xxs'></input>
