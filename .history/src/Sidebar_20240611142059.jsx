...
<div className="bg-n1-blue text-n1-white w-64 flex flex-col font-custom">
      ...
      <nav className="mt-4 flex-grow ml-4 mr-4 tracking-wide text-base font-medium">
              ...
              <div className='flex items-center pl-4 pb-4 pt-2'>
              <FaMagnifyingGlass /> 
              ...
              <BiBookmark />
              <a href="#" className='ml-4 hover:text-n1-blue-mid'>Saved Jobs</a>
              </div>
              ...
              <TbPhone />
              <a href="#" className='ml-4 hover:text-n1-blue-mid mb-5'>Contact</a>
              </div>
