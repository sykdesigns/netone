...
const AppHeader = () => {
    ...
    return (
        ...
        <div className='w-full h-24 bg-n1-blue-light flex items-center font-custom p-7 gap-2'>
            ...
            <div className='text-md font-demiBold md:text-2xl text-n1-blue md:w-full w-1/3 flex'>
            ...
            <form className='flex-grow flex items-center relative'>   
                ...
                className='md:w-8/12 h-10 pl-10 mr-12 text-xs border border-gray-300 rounded-lg'
                />
            </form>
