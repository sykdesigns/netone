...
const JobDetailsModal = ({ job, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-end z-50">
      ...
      <div className="relative w-screen h-screen md:w-[850px] bg-white overflow-auto text-n1-blue transform transition-transform duration-1500 ease-in-out md:translate-x-0">
