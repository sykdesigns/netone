...
const JobCards = ({ postDate, position, industry, projectSummary, billingRateW2, billingRateIC }) => {
  ...
  return (
    <div className='flex flex-col w-80 h-72 bg-n1-blue-light p-4 rounded-lg shadow-lg m-4'>
      ...
      <div className='flex mt-4'>
        <button className='bg-n1-blue-mid border-2 border-n1-blue-mid text-n1-blue-light text-xs px-4 py-2 rounded-full mr-2'>View Details</button>
