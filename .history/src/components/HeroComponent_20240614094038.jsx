    ...
    return (
        ...
        <div className='flex max-w-screen-2xl'>
            <div className='w-11/12 sm:w-1/2 font-custom text-n1-blue flex flex-col m-auto sm:pl-20 sm:pt-10 sm:pb-14 gap-6 p-6'>
                ...
                <h1 className='text-3xl text-center sm:text-left lg:text-8xl tracking-relax font-demiBold'>Welcome to the Future of Work<span className='text-n1-orange font-bold'>.</span></h1>
