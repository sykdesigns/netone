...
const Testimonials = (props) => {
  ...
  return (
    ...
    <div className='flex flex-col p-24 transition-all duration-700 max-w-7xl bg-custom-gradient-light'>

        <Card review = {reviews[index]}></Card>
     

      <div className='flex text-3xl text-n1-white font-bold items-center justify-end mt-12'>
        <button 
