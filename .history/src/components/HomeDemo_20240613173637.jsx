...
return(
        ...
        <section id="request_demo" className="w-full bg-n1-blue-light p-8 md:p-16">
            ...
            <div className="flex flex-col max-w-7xl m-auto">
                ...
                <div className="flex sm:flex-col md:items-center justify-between p-8 md:p-12">
                    <h3 className="text-xl md:text-2xl text-n1-blue md:w-6/12">NetOne Recruiter leverages innovative technology to accelerate speed to hire for all users.</h3>
