...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <section id='gig-economy' className='bg-n1-blue'>
            ...
            <div className="w-full flex flex-col items-center text-n1-white p-6 sm:p-12">
                <h2 className="text-2xl uppercase text-center tracking-wider font-custom mb-2">we power the gig economy</h2>
                <p className="tracking-wide text-sm sm:text-md w-11/12 text-center">By connecting talent leaders directly to our community of contract recruiters with an easy-to-use, seamless, digital platform.</p>
            </div>

        
        <div className="flex lg:flex-row flex-col items-start justify-center max-w-7xl m-auto lg:h-72 h-full flex-shrink-0">

            <div className="w-2/3 lg:w-1/3 lg:h-3/4 text-n1-white flex flex-col items-center m-auto lg:border-solid lg:border-r p-3">
            ...
            <p className="text-sm tracking-wide text-center w-2/3 mb-8">Create your company profile, post jobs and engage immediately with available recruiters.</p>
            </div>

            <div className="w-2/3 m-auto lg:w-1/3 lg:h-3/4 text-n1-white flex flex-col items-center lg:border-solid lg:border-r p-3">
            ...
            <p className="text-sm tracking-wide text-center w-2/3 mb-8">All recruiters complete NetOne Recruiter’s skill screening assessment.</p>
            </div>

            <div className="w-2/3 m-auto lg:w-1/3 lg:h-3/4 text-n1-white flex flex-col items-center p-3 mb-20">
