        ...
        <section id="request_demo" className="w-full bg-n1-blue-light">
            ...
            <div className="flex flex-col max-w-7xl m-auto">
                ...
                <div className="flex items-start">
                    <div className=" w-1/3 flex flex-col p-12 text-n1-blue">
                        <img src="../public/ico-demo-video.png" className="w-12"></img>
                        <h4 className="font-custom font-demiBold mt-2">Pre-Recorded Video Interviews</h4>
                        <p className="text-sm">Our rate analysis tool provides guidance on contract recruiter market bill rates.</p>
                    </div>

                    <div className=" w-1/3 flex flex-col p-12 text-n1-blue items-start">
                        <img src="../public/ico-demo-tracking.png" className="w-12"></img>
