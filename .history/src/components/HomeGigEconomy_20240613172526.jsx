...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <div className="flex items-start justify-center max-w-7xl m-auto h-64 flex-shrink-0">
            ...
            <div className="sm:w-10 sm: h-10 md:w-16 md:h-16 bg-n1-white rounded-full flex items-center justify-center mb-4"><img src="../public/ico_scalability.png" className="sm:w-4 md:w-8"></img></div>
