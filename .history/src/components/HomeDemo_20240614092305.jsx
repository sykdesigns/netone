        ...
        <section id="request_demo" className="w-full bg-n1-blue-light p-8 md:p-16">
            ...
            <div className="flex flex-col max-w-7xl m-auto">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between p-4 lg:p-12">
                    ...
                    <button className="bg-n1-blue text-n1-white font-custom text-sm rounded-full px-8 py-4 lg:w-1/2 flex items-center justify-between">Request A Demo <FaRegArrowAltCircleRight /></button>
                </div>
