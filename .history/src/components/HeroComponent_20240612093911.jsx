...
const HeroComponent = () => {
    ...
    return (
        ...
        <div className='flex max-w-7xl m-auto'>
            ...
            <div className='w-1/2 font-custom text-n1-blue m-auto flex flex-col items-center p-4'>
                <div><HeroVid /></div>
                <p className='text-lg m-6'>Cloud based access to world-class IT professionals and recruiters.</p>
