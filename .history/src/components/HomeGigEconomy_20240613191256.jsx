...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <section id='gig-economy' className='bg-n1-blue'>
            ...
            <div className="w-full flex md:flex-col items-center text-n1-white sm:p-8 md:p-12">
        ...
        <div className="flex sm:flex-col items-start justify-center max-w-7xl m-auto h-full md:h-64 flex-shrink-0">
