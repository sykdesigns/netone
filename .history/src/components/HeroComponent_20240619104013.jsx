...
const HeroComponent = () => {
    ...
    return (
        ...
        <section id='hero' className='bg-n1-white bg-custom-gradient flex justify-center'>
            ...
            <div className='sm:hidden font-custom text-n1-blue'>
                <div><HeroVid /></div>
               
            </div>

        <div className='flex w-full max-w-screen-2xl'>
            <div className='sm: w-1/2 sm:w-1/2 font-custom text-n1-blue flex flex-col m-auto sm:pl-20 sm:pt-10 sm:pb-14 gap-6 p-6'>
