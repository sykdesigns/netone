...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <div className="flex md:flex-row sm:flex-col items-start justify-center max-w-7xl m-auto h-full h-72 flex-shrink-0">

            <div className="w-full h-72 md:w-1/3 text-n1-white flex flex-col items-center border-solid border-r p-3">
            ...
            <div className="w-full justify-center h-72 md:w-1/3 text-n1-white flex flex-col items-center border-solid border-r p-3">
            ...
            <div className="w-full md:w-1/3 text-n1-white flex flex-col items-center p-3">
