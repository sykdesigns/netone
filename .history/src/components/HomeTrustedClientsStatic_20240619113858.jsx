        ...
        <div className="flex flex-col items-center">
            <h2 className="text-xl font-bold">Trusted Clients</h2>
                <div className="flex items-center w-full p-2 mt-3">
                    ...
                    <div className='w-1/3'><img src="/clients-logo-xela-color.png" className="w-full" alt="Xela" /></div>  
                </div>
                ...
                <div className='flex items-center w-full p-2'>
                    ...
                    <div className='w-1/3'> <img src="/clients-logo-cars-color.png" className="w-full" alt="Cars" /></div>
                </div>
