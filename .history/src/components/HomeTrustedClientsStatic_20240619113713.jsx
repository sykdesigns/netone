        ...
        <div className="flex flex-col items-center">
            <h2 className="text-xl font-bold">Trusted Clients</h2>
                ...
                <div className='w-full flex items-center'>
                    ...
                    <div className='w-1/3'><img src="/clients-logo-kreatr-color.png" className="w-24 m-2" alt="Kreatr" /></div>
                    <div className='w-1/3'><img src="/clients-logo-smartsheet-color.png" className="w-36" alt="Smartsheet" /></div>
                </div>
                <div className=''>
