...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <div className="flex lg:flex-row flex-col items-start justify-center max-w-7xl m-auto p-8 lg:h-72 h-full flex-shrink-0">
            ...
            <div className="w-full lg:w-1/3 lg:h-3/4 text-n1-white flex lg:flex-col lg:items-center lg:p-3">
            <div className="w-16 h-16 bg-n1-white rounded-full flex-col items-center justify-center mb-4"><img src="../public/ico_costs.png" className="w-5"></img></div>
