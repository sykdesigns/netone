        ...
        <section id="request_demo" className="w-full bg-n1-blue-light p-8 md:p-16">
            ...
            <div className="flex flex-col max-w-7xl m-auto">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between p-4 lg:p-8">
                    <h3 className="text-lg md:text-2xl text-n1-blue mb-8 w-full md:w-6/12">NetOne Recruiter leverages innovative technology to accelerate speed to hire for all users.</h3>
                    <button className="bg-n1-blue text-n1-white font-custom text-sm rounded-full px-8 py-4 lg:w-1/4 flex items-center justify-between">Request A Demo <FaRegArrowAltCircleRight /></button>
                </div>

                <div className="flex flex-col lg:flex-row mt-4">
                    <div className="w-full lg:w-1/3 flex flex-col p-8 p-12 text-n1-blue">
                        <img src="/ico-demo-rate.png" className="w-16"></img>
                    ...
                    <div className="w-full lg:w-1/3 flex flex-col p-8 p-12 text-n1-blue">
                        <img src="/ico-demo-assessments.png" className="w-12"></img>
                ...
                <div className="flex flex-col lg:flex-row justify-between">
                    <div className="w-full lg:w-1/3 flex flex-col p-8 p-12 text-n1-blue">
                        <img src="/ico-demo-video.png" className="w-12 h-12"></img>
                        <h4 className="font-custom font-demiBold mt-2">Pre-Recorded Video Interviews</h4>
                        <p className="text-sm">Our rate analysis tool provides guidance on contract recruiter market bill rates.</p>
                    </div>

                    <div className="w-full lg:w-1/3 flex flex-col p-8 p-12 text-n1-blue">
                        <img src="/ico-demo-tracking.png" className="w-12 h-12"></img>
                    ...
                    <div className="w-full lg:w-1/3 flex flex-col p-8 p-12 text-n1-blue">
                        <img src="/ico-demo-contract.png" className="w-16 h-12"></img>
