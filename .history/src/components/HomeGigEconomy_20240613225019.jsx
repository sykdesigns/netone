...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <div className="flex lg:flex-row flex-col items-start justify-center max-w-7xl m-auto lg:h-72 h-full flex-shrink-0">
            ...
            <div className="w-2/3 lg:w-1/3 lg:h-3/4 text-n1-white flex flex-col items-center justify-center lg:border-solid lg:border-r p-3">
            ...
            <div className="w-full lg:w-1/3 lg:h-3/4 text-n1-white flex flex-col items-center lg:border-solid lg:border-r p-3">
