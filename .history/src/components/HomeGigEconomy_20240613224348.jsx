...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <div className="flex lg:flex-row flex-col items-start justify-center max-w-7xl m-auto p-8 lg:h-72 h-full flex-shrink-0 bg-pink-100">

            <div className="w-full lg:w-1/3 lg:h-3/4 text-n1-white flex flex-col items-center lg:border-solid lg:border-r lg:p-3 flex-shrink">
