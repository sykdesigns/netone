...
const HeroComponent = () => {
    ...
    return (
        ...
        <div className='flex max-w-screen-2xl m-auto'>
            <div className='w-full lg:w-1/2 font-custom text-n1-blue flex flex-col pl-10 md:pl-14 lg:pt-10 lg:pb-14 gap-4 pt-6 pb-6'>
                ...
                <p className='text-xl lg:text-2xl flex p-4'>Cloud-based access to world-class IT professionals and recruiters.</p>
