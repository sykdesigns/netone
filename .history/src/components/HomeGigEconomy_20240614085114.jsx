    ...
    return (
        ...
        <section id='gig-economy' className='bg-n1-blue'>
            ...
            <div className="w-full flex flex-col items-center text-n1-white p-8">
                ...
                <p className="tracking-wide sm:text-md w-3/4 text-center">By connecting talent leaders directly to our community of contract recruiters with an easy-to-use, seamless, digital platform.</p>
            </div>
