    ...
    return (
        ...
        <div className='flex max-w-screen-2xl m-auto '>
            <div className='w-1/2 font-custom text-n1-blue flex flex-col pl-14 pt-14 pb-14 gap-4'>
                ...
                <h1 className='text-8xl tracking-relax font-demiBold'>Welcome  <span className='text-7xl'>to the </span> Future of Work<span className='text-n1-orange font-bold'>.</span></h1>
