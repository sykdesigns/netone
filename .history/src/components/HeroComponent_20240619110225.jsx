...
const HeroComponent = () => {
    ...
    return (
    <section id='hero' className='bg-n1-white bg-custom-gradient flex flex-col sm:flex-row justify-center p-4'>
            ...
            <div className='w-full sm:w-1/2 font-custom text-n1-blue flex flex-col m-auto sm:pl-20 sm:pt-10 sm:pb-14 gap-6 p-6'>
                ...
                <button className='text-n1-white bg-n1-orange rounded-full px-5 py-3 w-full flex items-center justify-between'>
