    ...
    return (
        ...
        <div className='flex max-w-screen-2xl m-auto'>
            <div className='w-full lg:w-1/2 font-custom text-n1-blue flex flex-col lg:pl-10 lg:pt-10 lg:pb-14 gap-4 p-6'>
                ...
                <button className='text-n1-white bg-n1-orange rounded-full px-5 py-3 w-full flex items-center justify-between'>Hire Talent <FaRegArrowAltCircleRight /></button>
