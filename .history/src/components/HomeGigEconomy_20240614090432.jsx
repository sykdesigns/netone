...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <div className="flex lg:flex-row flex-col items-start justify-center max-w-7xl m-auto lg:h-72 h-full flex-shrink-0">
            ...
            <p className="text-s sm:text-md tracking-wide text-center w-11/12 sm:w-1/2 mb-8">All recruiters complete NetOne Recruiter’s skill screening assessment.</p>
            </div>

            <div className="w-full lg:w-1/3 lg:h-3/4 text-n1-white flex flex-col items-center m-auto mb-12">
            ...
            <p className="text-sm sm:text-md tracking-wide text-center w-11/12 sm:w-1/2">There are no subscription fees - hourly billing commences once a recruiter is selected and begins working.</p>
            </div>
