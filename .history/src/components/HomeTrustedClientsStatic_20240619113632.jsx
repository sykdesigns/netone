        ...
        <div className="flex flex-col items-center">
            <h2 className="text-xl font-bold">Trusted Clients</h2>
                ...
                <div className='w-full flex'>
                    <div className='w-1/3'><img src="/clients-logo-cupertino-color.png" className="w-full" alt="Cupertino" /></div>
                    <div className='w-1/3'><img src="/clients-logo-GDH-color.png" className="w-24 m-2" alt="GDH" /></div>
                    <div className='w-1/3'><img src="/clients-logo-cupertino-color.png" className="w-full" alt="Cupertino" /></div>
                </div>
                <div className=''>
