...
const HeroComponent = () => {
    ...
    return (
        ...
        <div className='flex max-w-7xl m-auto'>
            <div className='w-1/2 font-custom text-n1-blue flex flex-col pl-14 pt-14 pb-14'>
                
                <h1 className='text-8xl capitalize tracking-relax font-demiBold'>welcome to the future of work</h1>
                <p className='text-lg'>Cloud based access to world-class IT professionals and recruiters.</p>
