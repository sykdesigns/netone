...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <div className="flex items-start justify-center max-w-7xl m-auto h-64 flex-shrink-0">
            ...
            <p className="text-sm font-custom text-center w-2/3">There are no subscription fees - hourly billing commences once a recruiter is selected and begins working.</p>
            </div>
