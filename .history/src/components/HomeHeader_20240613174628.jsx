...
const HomeHeader = () => {
  return (
    <div className='w-full flex font-custom p-10 md:p-6 bg-n1-white border-solid border-b border-n1-blue-light'>

        <div className='flex items-center'>
            <img src='../public/logo-netOne.png' className='w-32'></img>
            <div className='flex ml-auto'><RxHamburgerMenu /></div>
