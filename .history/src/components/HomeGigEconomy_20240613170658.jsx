    ...
    return (
        ...
        <section id='block1' className='bg-n1-blue'>
            ...
            <div className="w-full flex flex-col items-center text-n1-white p-12">
                ...
                <p className="tracking-wide text-md lg:w-1/3">By connecting talent leaders directly to our community of contract recruiters with an easy-to-use, seamless, digital platform.</p>
            </div>
