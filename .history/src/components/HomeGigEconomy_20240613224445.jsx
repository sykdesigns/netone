    ...
    return (
        ...
        <section id='gig-economy' className='bg-n1-blue'>
            ...
            <div className="w-full flex flex-col items-center text-n1-white sm:p-8 md:p-12">
                ...
                <p className="tracking-wide text-md w-1/2 lg:w-3/4 text-center">By connecting talent leaders directly to our community of contract recruiters with an easy-to-use, seamless, digital platform.</p>
            </div>
