    ...
    return (
        ...
        <section id='block1' className='bg-n1-blue'>
            ...
            <div className="w-full flex flex-col items-center text-n1-white p-12">
                <h1 className="text-2xl uppercase tracking-wider font-custom mb-2">we power the gig economy</h1>
        ...
        <div className="flex items-center justify-center max-w-2xl h-64">
            <div className="w-1/3 text-n1-white flex items-center justify-center">Maximize Scalability</div>
