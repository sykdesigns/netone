  ...
  return (
    <div className='relative flex flex-col lg:w-80 lg:h-70 bg-n1-blue-light p-4 rounded-lg shadow-md'>
      ...
      <div className='flex mt-4 ml-auto'>
        <button className='bg-n1-white border-2 border-n1-blue-mid text-n1-blue text-xs px-4 py-2 rounded-full mr-2 hover:bg-n1-blue' onClick={onViewDetails}>View Details</button>
