  ...
  return (
    <div className='w-screen font-custom p-6 bg-n1-white border-solid border-b border-n1-blue-light'>
        ...
        <div className='flex flex-row items-center w-full'>
            ...
            <RxHamburgerMenu className='block lg:hidden flex justify-end' />

       
{/* 
        <nav className='sm:hidden md:hidden font-custom text-n1-blue flex ml-auto items-center text-sm gap-6'>
