      ...
      <div className="relative w-screen h-screen md:w-[800px] bg-white overflow-auto text-n1-blue transform transition-transform duration-1000 ease-in-out md:translate-x-0">
        <div className="flex bg-n1-blue-light">
          ...
          <div className="w-1/4 flex items-center p-4">
            <button
              onClick={onClose}
              className="bg-n1-orange hover:bg-n1-blue rounded-full w-6 h-6 flex items-center justify-center text-sm text-n1-white font-custom font-demiBold ml-auto"
            >
              X
            </button>
          </div>
        ...
        <div className="flex flex-col gap-6 pl-7 pt-4 pb-4 bg-n1-blue-light">
        ...
        <div className="flex flex-col gap-6 pl-7 pt-4 pb-4">
        ...
        <div className="flex p-4 items-center justify-center mt-2 font-custom">
          <button className="border border-n1-blue bg-n1-white px-7 py-2 rounded-full hover:bg-n1-orange hover:text-n1-white hover:border-n1-white" onClick={onClose}>Close</button>
          <button className="ml-2 bg-n1-orange px-7 py-2 rounded-full text-n1-white hover:bg-n1-blue" onClick={onApplyNow}>Apply Now</button>
        </div>
      </div>
    </div>
  );
