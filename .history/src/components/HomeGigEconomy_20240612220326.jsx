...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <div className="flex items-start justify-center max-w-7xl m-auto h-64 flex-shrink-0">
            ...
            <div className="w-1/3 h-80 overflow-hidden text-n1-white flex flex-col items-center border-solid border-r p-3">
            ...
            <div className="w-1/3 h-80 text-n1-white flex flex-col items-center border-solid border-r p-3">
            ...
            <div className="w-1/3 h-80 text-n1-white flex flex-col items-center p-3">
