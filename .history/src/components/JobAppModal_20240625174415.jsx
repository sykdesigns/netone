       ...
       <div className="relative w-screen h-screen md:w-[800px] bg-white overflow-auto text-n1-blue transform transition-transform duration-1000 ease-in-out md:translate-x-0">
            <div className="flex bg-n1-blue-light">
                ...
                <div className="w-1/4 flex items-center p-4">
                    <button
                    onClick={onClose}
                    className="bg-n1-orange rounded-full w-6 h-6 flex items-center justify-center text-sm text-n1-white font-custom font-demiBold ml-auto hover:bg-n1-blue"
                    >
                    X
                    </button>
                </div>
            ...
            <div className="flex flex-col sm:w-full sm:m-12 m-8">
            ...
            <div className='flex flex-col sm:m-12 m-4'>

                <h2 className="font-custom font-demiBold mb-4">Upload a cover letter <span className='text-n1-orange text-xs font-light'> *Optional</span></h2>
                    ...
                    <div class="flex justify-center">
                        <label for="dropzone-file" class="flex justify-center w-9/12 h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-xs sm:text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span> or drag and drop</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">PDF or DOC (MAX 5gb)</p>
                            </div>
            ...
            <button className="border border-n1-blue bg-n1-white px-7 py-2 rounded-full hover:bg-n1-orange hover:text-n1-white hover:border-n1-white" onClick={onClose}>Cancel</button>
            <button className="ml-2 bg-n1-orange px-7 py-2 rounded-full text-n1-white pointer-events-none text-gray-400 cursor-not-allowed">Submit</button>
            </div>
