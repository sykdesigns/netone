    ...
    return (
        ...
        <section id='gig-economy' className='bg-n1-blue'>
            ...
            <div className="w-full flex flex-col items-center text-n1-white sm:p-8 md:p-12">
                ...
                <p className="tracking-wide text-md w-3/4 lg:w-3/4 text-center">By connecting talent leaders directly to our community of contract recruiters with an easy-to-use, seamless, digital platform.</p>
            </div>

        
        <div className="flex lg:flex-row flex-col items-start justify-center max-w-7xl m-auto p-8 lg:h-72 h-full flex-shrink-0">

            <div className="w-full lg:w-1/3 lg:h-3/4 text-n1-white flex flex-col items-center lg:border-solid lg:border-r lg:p-3">
            ...
            <div className="w-full lg:w-1/3 lg:h-3/4 text-n1-white flex flex-col items-center p-3">
