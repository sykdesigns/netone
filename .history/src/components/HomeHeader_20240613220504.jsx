  ...
  return (
    <div className='w-full flex font-custom p-6 md:p-6 bg-n1-white border-solid border-b border-n1-blue-light'>
        ...
        <div className='flex items-center justify-between'>
            ...
            <RxHamburgerMenu className='sm:visible md:iinvisible' />

        </div>

        <nav className='sm:invisible md:visible font-custom text-n1-blue flex ml-auto items-center text-sm gap-6'>
