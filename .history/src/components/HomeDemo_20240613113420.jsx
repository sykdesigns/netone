...
return(
        ...
        <section id="request_demo" className="w-full p-12">
            ...
            <div className="flex flex-col p-12 font-custom text-n1-blue">
                <img src="../public/ico-demo-rate.png" className="w-16"></img>
                <h4>Recruiter Rate Validation</h4>
                <p>Our rate analysis tool provides guidance on contract recruiter market bill rates.</p>
            </div>
