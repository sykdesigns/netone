    ...
    return (
        ...
        <div className='flex max-w-6xl m-auto'>
            ...
            <div className='w-1/2 font-custom text-n1-blue m-auto flex flex-col items-center'>
                <p className='text-sm w-1/2 p-6'>Cloud based access to world-class IT professionals and recruiters.</p>
                <button className='text-n1-white bg-n1-orange rounded-full px-12 py-3 mt-2'>Hire Talent</button>
            </div>
        </div>
    );
}
