    ...
    return (
        ...
        <div className='flex max-w-screen-2xl m-auto'>
            <div className='w-1/2 font-custom text-n1-blue flex flex-col pl-14 pt-10 pb-14 gap-4'>
                ...
                <button className='text-n1-white bg-n1-orange rounded-full px-12 py-3 w-full flex items-center justify-between'>Hire Talent <FaRegArrowAltCircleRight /></button>
