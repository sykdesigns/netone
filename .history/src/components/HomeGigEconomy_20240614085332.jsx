    ...
    return (
        ...
        <section id='gig-economy' className='bg-n1-blue'>
            ...
            <div className="w-full flex flex-col items-center text-n1-white p-6 sm:p-12">
                ...
                <p className="tracking-wide leading-relaxed text-sm sm:text-md w-11/12 text-center">By connecting talent leaders directly to our community of contract recruiters with an easy-to-use, seamless, digital platform.</p>
            </div>
