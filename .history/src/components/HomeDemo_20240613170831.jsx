...
return(
        ...
        <section id="request_demo" className="w-full bg-n1-blue-light p-24 lg:p-18">

            <div className="flex flex-col max-w-7xl m-auto">
            
                <div className="flex items-center justify-between p-12">
                    <h3 className="text-2xl text-n1-blue w-5/12">NetOne Recruiter leverages innovative technology to accelerate speed to hire for all users.</h3>
