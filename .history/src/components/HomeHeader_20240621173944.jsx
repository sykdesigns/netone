  ...
  return (
    <div className='w-screen font-custom p-6 bg-n1-white border-solid border-b border-n1-blue-light'>
        ...
        <div className='flex flex-row items-center w-full'>
            ...
            <img src='../public/logo-netOne.png' className='w-24 lg:w-32'></img>
            <RxHamburgerMenu className='block lg:hidden flex ml-auto' />

       

            <nav className='hidden lg:flex font-custom text-n1-blue items-center ml-auto text-sm gap-6'>
              <div>Find Contractors</div>
              <div><a href='#' className='onClick={handleNavigateToJobs}'>Find Work</a></div>
              <div>Log In</div>
