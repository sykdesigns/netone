...
const HomeBlock1 = () => {
    ...
    return (
        ...
        <div className="flex items-center justify-center h-64 max-w-7xl m-auto">
            ...
            <div className="w-1/3 text-n1-white flex flex-col items-center justify-center border-solid border-r">
            <div className="w-16 h-16 bg-n1-white rounded-full flex items-center justify-center mb-4"><img src="../public/ico_scalability.png" className="w-8"></img></div>
            <h3>Maximize Scalability</h3>
            <p className="text-sm text-center">Create your company profile, post jobs and engage immediately with available recruiters.</p>
            </div>

            <div className="w-1/3 text-n1-white flex flex-col items-center justify-center">
            <div className="w-16 h-16 bg-n1-white rounded-full flex items-center justify-center mb-4"><img src="../public/ico_scalability.png" className="w-8"></img></div>
            <h3>Maximize Scalability</h3>
            <p className="text-sm text-center">Create your company profile, post jobs and engage immediately with available recruiters.</p>
            </div>
