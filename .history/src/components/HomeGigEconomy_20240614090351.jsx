...
const HomeGigEconomy = () => {
    ...
    return (
        ...
        <div className="flex lg:flex-row flex-col items-start justify-center max-w-7xl m-auto lg:h-72 h-full flex-shrink-0">
            ...
            <p className="text-sm sm:text-md tracking-wide text-center w-11/12 sm:w-1/2 mb-8">Create your company profile, post jobs and engage immediately with available recruiters.</p>
            </div>
