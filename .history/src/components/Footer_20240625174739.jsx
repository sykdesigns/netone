        ...
        <section id="footer" className="bg-custom-gradient">
            ...
            <div className="bg-gray-light w-full mt-28 lg:mt-32">
                <div className="flex font-custom text-n1-blue gap-5">
                    <img src="/ico-social-fb.png" className="w-12"></img>
                    <img src="/ico-social-in.png"></img>
                    <img src="/ico-social-x.png"></img>
                    <img src="/ico-social-youtube.png"></img>
                    <img src="/ico-social-insta.png"></img>
                </div>
            ...
            {/* <div className="">
                <img src="/graphic-leaves.png"></img>
            </div> */}
