    ...
    <div className="fixed inset-0 flex justify-center z-50">
      <div className="bg-white w-screen h-screen overflow-auto font-custom text-n1-blue">
        ...
        <div className='flex bg-n1-blue-light'>
            ...
            <p className='text-n1-gray-dark text-xs'>Last Modified: {job["Post Date"]}</p>
            <h1 className='text-xl font-demiBold text-n1-orange'>{job.Position}</h1>
            </div>
        ...
        <div className='flex flex-col gap-4 p-5 bg-n1-blue-light'>
                ...
                <div className='w-full'><span className='font-demiBold'>Billing Rate:</span> {job["Billing Rate"]}</div>
                <div className='w-full'><span className='font-demiBold'>Onsite / Remote:</span> {job["Onsite / Remote"]}</div>
        ...
        <div className='flex flex-col gap-4 p-5'>
                ...
                <div className='w-full'><span className='font-demiBold'>Travel Requirements:</span> {job["Travel Requirements"]}</div>
                <div className='w-full'><span className='font-demiBold'>Language:</span> {job.Language}</div>
        ...
        <div className='flex flex-col gap-4 p-5'>
                ...
                <div className='w-full'><span className='font-demiBold'>Project Summary:</span> {job["Project Summary"]}</div>

        </div>

        <div className='flex p-4 items-center justify-center mt-4'>
            <button className='border border-n1-blue bg-n1-white text-base px-7 py-2 rounded-full' onClick={onClose}>Close</button>
