...
const App = () => {
  ...
  const filteredJobs = jobData.filter((job) => {
    ...
    console.log('Project Summary Match:', projectSummaryMatch);
    console.log('Industries Match:', industriesMatch);

    return positionMatch || projectSummaryMatch || industriesMatch;
  });
