    ...
    <div className="fixed inset-0 flex justify-end z-50">
      ...
      <div className="relative w-screen h-screen md:w-[800px] bg-white overflow-auto text-n1-blue transform transition-transform duration-1000 ease-in-out md:translate-x-0">
        ...
        <div className="flex flex-col w-full m-8">
          ...
          <h2 className="font-custom font-demiBold mt-4">Upload a cover letter <span className='text-n1-orange text-xs font-light'>*Optional</span></h2>
          <p>Upload files</p>
          ...
          <form>
            ...
            <div class="flex w-full justify-center ">
                <label for="dropzone-file" class="flex flex-col w-10/12 items-center justify-center h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
